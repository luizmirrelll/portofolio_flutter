...
class MeSummary extends StatelessWidget {
  final bool horizontal;

  const MeSummary({Key key, this.horizontal}) : super(key: key);
    ...
    final aboutMeContent = new Container(
      ...
      child: new Column(
        children: <Widget>[
          ...
          new Container(
              height: 30.0, padding: EdgeInsets.only(top: 40, bottom: 40)),
          new Text(
            'Aloysius Mirel',
            style: TextStyle(
              fontFamily: 'Curve',
